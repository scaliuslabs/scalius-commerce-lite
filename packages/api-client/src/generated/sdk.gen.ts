...
/**
 * Atomically create and update product variants
 */
export const postApiV1AdminProductsByIdVariantsEditPlan = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AdminProductsByIdVariantsEditPlanData, ThrowOnError>): RequestResult<PostApiV1AdminProductsByIdVariantsEditPlanResponses, PostApiV1AdminProductsByIdVariantsEditPlanErrors, ThrowOnError> => (options.client ?? client).post<PostApiV1AdminProductsByIdVariantsEditPlanResponses, PostApiV1AdminProductsByIdVariantsEditPlanErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
