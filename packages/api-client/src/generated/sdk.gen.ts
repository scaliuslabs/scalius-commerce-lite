 ...
 */
export const postApiV1AdminOrdersIdInvoice = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AdminOrdersIdInvoiceData, ThrowOnError>): RequestResult<PostApiV1AdminOrdersIdInvoiceResponses, PostApiV1AdminOrdersIdInvoiceErrors, ThrowOnError> => (options.client ?? client).post<PostApiV1AdminOrdersIdInvoiceResponses, PostApiV1AdminOrdersIdInvoiceErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
