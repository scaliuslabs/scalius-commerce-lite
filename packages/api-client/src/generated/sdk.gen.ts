...
/**
 * Search customers for Admin MCP with redacted customer projection
 */
export const postApiV1AdminCustomersMcpSearch = <ThrowOnError extends boolean = false>(options?: Options<PostApiV1AdminCustomersMcpSearchData, ThrowOnError>): RequestResult<PostApiV1AdminCustomersMcpSearchResponses, PostApiV1AdminCustomersMcpSearchErrors, ThrowOnError> => (options?.client ?? client).post<PostApiV1AdminCustomersMcpSearchResponses, PostApiV1AdminCustomersMcpSearchErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
...
/**
 * Read supported controls for the configured image model
 */
export const getApiV1AdminMediaImageGenerationCapabilities = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1AdminMediaImageGenerationCapabilitiesData, ThrowOnError>): RequestResult<GetApiV1AdminMediaImageGenerationCapabilitiesResponses, GetApiV1AdminMediaImageGenerationCapabilitiesErrors, ThrowOnError> => (options?.client ?? client).get<GetApiV1AdminMediaImageGenerationCapabilitiesResponses, GetApiV1AdminMediaImageGenerationCapabilitiesErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
...
/**
 * Generate one ephemeral AI image preview
 */
export const postApiV1AdminMediaImageGenerationGenerate = <ThrowOnError extends boolean = false>(options?: Options<PostApiV1AdminMediaImageGenerationGenerateData, ThrowOnError>): RequestResult<PostApiV1AdminMediaImageGenerationGenerateResponses, PostApiV1AdminMediaImageGenerationGenerateErrors, ThrowOnError> => (options?.client ?? client).post<PostApiV1AdminMediaImageGenerationGenerateResponses, PostApiV1AdminMediaImageGenerationGenerateErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
...
/**
 * Verify and save a generated image preview to the media library
 */
export const postApiV1AdminMediaImageGenerationSave = <ThrowOnError extends boolean = false>(options?: Options<PostApiV1AdminMediaImageGenerationSaveData, ThrowOnError>): RequestResult<PostApiV1AdminMediaImageGenerationSaveResponses, PostApiV1AdminMediaImageGenerationSaveErrors, ThrowOnError> => (options?.client ?? client).post<PostApiV1AdminMediaImageGenerationSaveResponses, PostApiV1AdminMediaImageGenerationSaveErrors, ThrowOnError>({
...
/**
 * Get redacted Admin MCP notification settings summary
 */
export const getApiV1AdminSettingsNotificationChannelsMcpSummary = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1AdminSettingsNotificationChannelsMcpSummaryData, ThrowOnError>): RequestResult<GetApiV1AdminSettingsNotificationChannelsMcpSummaryResponses, GetApiV1AdminSettingsNotificationChannelsMcpSummaryErrors, ThrowOnError> => (options?.client ?? client).get<GetApiV1AdminSettingsNotificationChannelsMcpSummaryResponses, GetApiV1AdminSettingsNotificationChannelsMcpSummaryErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
...
/**
 * Get redacted Admin MCP settings readiness summary
 */
export const getApiV1AdminSettingsMcpSummary = <ThrowOnError extends boolean = false>(options?: Options<GetApiV1AdminSettingsMcpSummaryData, ThrowOnError>): RequestResult<GetApiV1AdminSettingsMcpSummaryResponses, GetApiV1AdminSettingsMcpSummaryErrors, ThrowOnError> => (options?.client ?? client).get<GetApiV1AdminSettingsMcpSummaryResponses, GetApiV1AdminSettingsMcpSummaryErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
 ...
 */
export const postApiV1AdminOrdersByIdReturn = <ThrowOnError extends boolean = false>(options: Options<PostApiV1AdminOrdersByIdReturnData, ThrowOnError>): RequestResult<PostApiV1AdminOrdersByIdReturnResponses, PostApiV1AdminOrdersByIdReturnErrors, ThrowOnError> => (options.client ?? client).post<PostApiV1AdminOrdersByIdReturnResponses, PostApiV1AdminOrdersByIdReturnErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
...
/**
 * Chat with the read-only admin assistant
 */
export const postApiV1AdminAiChat = <ThrowOnError extends boolean = false>(options?: Options<PostApiV1AdminAiChatData, ThrowOnError>): RequestResult<PostApiV1AdminAiChatResponses, PostApiV1AdminAiChatErrors, ThrowOnError> => (options?.client ?? client).post<PostApiV1AdminAiChatResponses, PostApiV1AdminAiChatErrors, ThrowOnError>({
    security: [{
            in: 'cookie',
            name: 'better-auth.session_token',
            type: 'apiKey'
