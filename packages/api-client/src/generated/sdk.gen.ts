 ...
 */
export const postApiV1MetaEvents = <ThrowOnError extends boolean = false>(options?: Options<PostApiV1MetaEventsData, ThrowOnError>): RequestResult<PostApiV1MetaEventsResponses, unknown, ThrowOnError> => (options?.client ?? client).post<PostApiV1MetaEventsResponses, unknown, ThrowOnError>({
