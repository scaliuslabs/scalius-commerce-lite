 ...
 * Get order by ID
 */
export const getApiV1OrdersById = <ThrowOnError extends boolean = false>(options: Options<GetApiV1OrdersByIdData, ThrowOnError>): RequestResult<GetApiV1OrdersByIdResponses, GetApiV1OrdersByIdErrors, ThrowOnError> => (options.client ?? client).get<GetApiV1OrdersByIdResponses, GetApiV1OrdersByIdErrors, ThrowOnError>({ url: '/api/v1/orders/{id}', ...options });
