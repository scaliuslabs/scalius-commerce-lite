 ...
 */
export const getApiV1MediaByKey = <ThrowOnError extends boolean = false>(options: Options<GetApiV1MediaByKeyData, ThrowOnError>): RequestResult<GetApiV1MediaByKeyResponses, GetApiV1MediaByKeyErrors, ThrowOnError> => (options.client ?? client).get<GetApiV1MediaByKeyResponses, GetApiV1MediaByKeyErrors, ThrowOnError>({ url: '/api/v1/media/{key}', ...options });
