CREATE TABLE `agent_audit_events` (
	...
	FOREIGN KEY (`grant_id`) REFERENCES `agent_grants`(`id`) ON UPDATE no action ON DELETE set null,
	FOREIGN KEY (`credential_id`) REFERENCES `agent_credentials`(`id`) ON UPDATE no action ON DELETE set null,
	...
	CONSTRAINT "agent_audit_events_resource_ids_json" CHECK(json_valid("agent_audit_events"."resource_ids_json") AND json_type("agent_audit_events"."resource_ids_json") = 'array' AND length("agent_audit_events"."resource_ids_json") BETWEEN 2 AND 4096),
	CONSTRAINT "agent_audit_events_metadata_json" CHECK(json_valid("agent_audit_events"."metadata_json") AND json_type("agent_audit_events"."metadata_json") = 'object' AND length("agent_audit_events"."metadata_json") BETWEEN 2 AND 8192)
);
--> statement-breakpoint
CREATE INDEX `agent_audit_events_grant_created_idx` ON `agent_audit_events` (`grant_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `agent_audit_events_credential_created_idx` ON `agent_audit_events` (`credential_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `agent_audit_events_owner_created_idx` ON `agent_audit_events` (`owner_user_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `agent_audit_events_operation_created_idx` ON `agent_audit_events` (`operation_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `agent_audit_events_outcome_created_idx` ON `agent_audit_events` (`outcome`,`created_at`);--> statement-breakpoint
CREATE INDEX `agent_audit_events_created_idx` ON `agent_audit_events` (`created_at`);--> statement-breakpoint
CREATE TABLE `agent_authorization_requests` (
	...
	`completion_claim_expires_at` integer,
...
--> statement-breakpoint
CREATE INDEX `agent_authorization_requests_status_expiry_idx` ON `agent_authorization_requests` (`status`,`expires_at`);--> statement-breakpoint
CREATE INDEX `agent_authorization_requests_client_created_idx` ON `agent_authorization_requests` (`client_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `agent_authorization_requests_grant_idx` ON `agent_authorization_requests` (`grant_id`);--> statement-breakpoint
CREATE INDEX `agent_authorization_requests_completion_claim_idx` ON `agent_authorization_requests` (`status`,`completion_claim_expires_at`);--> statement-breakpoint
CREATE TABLE `agent_credentials` (
	...
	`created_at` integer DEFAULT (cast(strftime('%s','now') as int)) NOT NULL,
	`updated_at` integer DEFAULT (cast(strftime('%s','now') as int)) NOT NULL,
	FOREIGN KEY (`grant_id`) REFERENCES `agent_grants`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`rotated_from_id`) REFERENCES `agent_credentials`(`id`) ON UPDATE no action ON DELETE set null,
...
--> statement-breakpoint
CREATE UNIQUE INDEX `agent_credentials_token_hash_uq` ON `agent_credentials` (`token_hash`);--> statement-breakpoint
CREATE INDEX `agent_credentials_grant_expiry_idx` ON `agent_credentials` (`grant_id`,`expires_at`);--> statement-breakpoint
CREATE INDEX `agent_credentials_active_expiry_idx` ON `agent_credentials` (`revoked_at`,`expires_at`);--> statement-breakpoint
CREATE INDEX `agent_credentials_rotated_from_idx` ON `agent_credentials` (`rotated_from_id`);--> statement-breakpoint
CREATE TABLE `agent_device_authorizations` (
	...
	CONSTRAINT "agent_device_authorizations_permissions_json" CHECK(json_valid("agent_device_authorizations"."requested_permissions_json") AND json_type("agent_device_authorizations"."requested_permissions_json") = 'array' AND length("agent_device_authorizations"."requested_permissions_json") BETWEEN 2 AND 65536),
...
--> statement-breakpoint
CREATE UNIQUE INDEX `agent_device_authorizations_device_code_uq` ON `agent_device_authorizations` (`device_code_hash`);--> statement-breakpoint
CREATE UNIQUE INDEX `agent_device_authorizations_user_code_uq` ON `agent_device_authorizations` (`user_code_hmac`);--> statement-breakpoint
CREATE INDEX `agent_device_authorizations_status_expiry_idx` ON `agent_device_authorizations` (`status`,`expires_at`);--> statement-breakpoint
CREATE INDEX `agent_device_authorizations_grant_idx` ON `agent_device_authorizations` (`grant_id`);--> statement-breakpoint
CREATE INDEX `agent_device_authorizations_credential_idx` ON `agent_device_authorizations` (`credential_id`);--> statement-breakpoint
CREATE TABLE `agent_grants` (
	...
	CONSTRAINT "agent_grants_permissions_json" CHECK(json_valid("agent_grants"."permissions_json") AND json_type("agent_grants"."permissions_json") = 'array' AND length("agent_grants"."permissions_json") BETWEEN 2 AND 65536),
	...
	CONSTRAINT "agent_grants_oauth_metadata" CHECK((
            ...
            AND json_valid("agent_grants"."oauth_redirect_uris_json") AND json_type("agent_grants"."oauth_redirect_uris_json") = 'array'
        ) OR (
...
--> statement-breakpoint
CREATE INDEX `agent_grants_owner_status_idx` ON `agent_grants` (`owner_user_id`,`status`);--> statement-breakpoint
CREATE INDEX `agent_grants_resource_status_expiry_idx` ON `agent_grants` (`resource`,`status`,`expires_at`);--> statement-breakpoint
CREATE INDEX `agent_grants_status_expiry_idx` ON `agent_grants` (`status`,`expires_at`);--> statement-breakpoint
CREATE INDEX `agent_grants_last_used_idx` ON `agent_grants` (`last_used_at`);--> statement-breakpoint
CREATE TABLE `agent_storefront_contexts` (
	...
	`updated_at` integer DEFAULT (cast(strftime('%s','now') as int)) NOT NULL,
	FOREIGN KEY (`grant_id`) REFERENCES `agent_grants`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`customer_session_token_hash`) REFERENCES `customer_sessions`(`token_hash`) ON UPDATE no action ON DELETE set null,
	...
	CONSTRAINT "agent_storefront_contexts_cart_json" CHECK(json_valid("agent_storefront_contexts"."cart_json") AND json_type("agent_storefront_contexts"."cart_json") = 'array' AND json_array_length("agent_storefront_contexts"."cart_json") BETWEEN 0 AND 99 AND length("agent_storefront_contexts"."cart_json") BETWEEN 2 AND 65536),
...
--> statement-breakpoint
CREATE INDEX `agent_storefront_contexts_grant_status_idx` ON `agent_storefront_contexts` (`grant_id`,`status`);--> statement-breakpoint
CREATE INDEX `agent_storefront_contexts_status_expiry_idx` ON `agent_storefront_contexts` (`status`,`expires_at`);--> statement-breakpoint
CREATE INDEX `agent_storefront_contexts_customer_session_idx` ON `agent_storefront_contexts` (`customer_session_token_hash`);--> statement-breakpoint
CREATE INDEX `agent_storefront_contexts_last_used_idx` ON `agent_storefront_contexts` (`last_used_at`);--> statement-breakpoint
CREATE TABLE `agent_storefront_continuations` (
	...
	`created_at` integer DEFAULT (cast(strftime('%s','now') as int)) NOT NULL,
	`updated_at` integer DEFAULT (cast(strftime('%s','now') as int)) NOT NULL,
	FOREIGN KEY (`context_id`) REFERENCES `agent_storefront_contexts`(`id`) ON UPDATE no action ON DELETE cascade,
	FOREIGN KEY (`order_id`) REFERENCES `orders`(`id`) ON UPDATE no action ON DELETE set null,
	FOREIGN KEY (`payment_attempt_id`) REFERENCES `payment_session_attempts`(`id`) ON UPDATE no action ON DELETE set null,
	...
	CONSTRAINT "agent_storefront_continuations_bootstrap_hash" CHECK("agent_storefront_continuations"."bootstrap_code_hash" IS NULL OR (
            length("agent_storefront_continuations"."bootstrap_code_hash") = 64
            AND "agent_storefront_continuations"."bootstrap_code_hash" NOT GLOB '*[^0-9a-f]*'
        )),
	...
	CONSTRAINT "agent_storefront_continuations_result_json" CHECK("agent_storefront_continuations"."safe_result_json" IS NULL OR (json_valid("agent_storefront_continuations"."safe_result_json") AND json_type("agent_storefront_continuations"."safe_result_json") = 'object' AND length("agent_storefront_continuations"."safe_result_json") BETWEEN 2 AND 8192)),
...
--> statement-breakpoint
CREATE INDEX `agent_storefront_continuations_context_status_idx` ON `agent_storefront_continuations` (`context_id`,`status`);--> statement-breakpoint
CREATE INDEX `agent_storefront_continuations_status_expiry_idx` ON `agent_storefront_continuations` (`status`,`expires_at`);--> statement-breakpoint
CREATE INDEX `agent_storefront_continuations_order_idx` ON `agent_storefront_continuations` (`order_id`);--> statement-breakpoint
CREATE INDEX `agent_storefront_continuations_payment_attempt_idx` ON `agent_storefront_continuations` (`payment_attempt_id`);--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX `agent_storefront_order_grants_order_expiry_idx` ON `agent_storefront_order_grants` (`order_id`,`expires_at`);--> statement-breakpoint
...
CREATE TABLE `agent_artifact_handles` (
	...
	CONSTRAINT "agent_artifact_handles_media_type" CHECK(length(trim("agent_artifact_handles"."media_type")) BETWEEN 1 AND 120 AND "agent_artifact_handles"."media_type" NOT GLOB '*[^ -~]*'),
	CONSTRAINT "agent_artifact_handles_filename" CHECK(length(trim("agent_artifact_handles"."filename")) BETWEEN 1 AND 160
            AND "agent_artifact_handles"."filename" NOT GLOB '*[^ -~]*'
            AND instr("agent_artifact_handles"."filename", '/') = 0
            AND instr("agent_artifact_handles"."filename", char(92)) = 0),
	CONSTRAINT "agent_artifact_handles_size" CHECK("agent_artifact_handles"."size_bytes" BETWEEN 1 AND 16777216),
	CONSTRAINT "agent_artifact_handles_sha256" CHECK(length("agent_artifact_handles"."sha256") = 64 AND "agent_artifact_handles"."sha256" NOT GLOB '*[^0-9a-f]*'),
	...
	CONSTRAINT "agent_artifact_handles_failure_class" CHECK("agent_artifact_handles"."failure_class" IS NULL OR (
            length("agent_artifact_handles"."failure_class") BETWEEN 1 AND 64
            AND "agent_artifact_handles"."failure_class" NOT GLOB '*[^a-z0-9_]*'
        )),
...
--> statement-breakpoint
CREATE UNIQUE INDEX `agent_artifact_handles_r2_key_uq` ON `agent_artifact_handles` (`r2_key`);--> statement-breakpoint
CREATE INDEX `agent_artifact_handles_grant_status_expiry_idx` ON `agent_artifact_handles` (`grant_id`,`status`,`expires_at`);--> statement-breakpoint
