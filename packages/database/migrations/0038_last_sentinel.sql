...
CREATE TABLE `__new_site_settings` (
	...
	`homepage_config` text DEFAULT '{}' NOT NULL,
	`homepage_config_revision` integer DEFAULT 1 NOT NULL,
	`robots_txt` text,
	...
	CONSTRAINT "site_settings_header_config_revision_positive" CHECK("header_config_revision" >= 1),
	CONSTRAINT "site_settings_footer_config_revision_positive" CHECK("footer_config_revision" >= 1),
	CONSTRAINT "site_settings_homepage_config_revision_positive" CHECK("homepage_config_revision" >= 1),
	CONSTRAINT "site_settings_checkout_flow_revision_positive" CHECK("checkout_flow_revision" >= 1)
);
--> statement-breakpoint
INSERT INTO `__new_site_settings`("id", "singleton_key", "logo", "favicon", "site_name", "site_description", "header_config", "header_config_revision", "footer_config", "footer_config_revision", "social_links", "contact_info", "site_title", "homepage_title", "homepage_meta_description", "homepage_config", "homepage_config_revision", "robots_txt", "storefront_url", "auth_verification_method", "guest_checkout_enabled", "checkout_mode", "partial_payment_enabled", "partial_payment_amount", "checkout_flow_revision", "whatsapp_access_token", "whatsapp_phone_number_id", "whatsapp_template_name", "created_at", "updated_at") SELECT "id", "singleton_key", "logo", "favicon", "site_name", "site_description", "header_config", "header_config_revision", "footer_config", "footer_config_revision", "social_links", "contact_info", "site_title", "homepage_title", "homepage_meta_description", '{}', 1, "robots_txt", "storefront_url", "auth_verification_method", "guest_checkout_enabled", "checkout_mode", "partial_payment_enabled", "partial_payment_amount", "checkout_flow_revision", "whatsapp_access_token", "whatsapp_phone_number_id", "whatsapp_template_name", "created_at", "updated_at" FROM `site_settings`;--> statement-breakpoint
