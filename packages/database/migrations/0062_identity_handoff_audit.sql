...
CREATE UNIQUE INDEX `admin_identity_handoff_events_jti_uidx` ON `admin_identity_handoff_events` (`jti_hash`);--> statement-breakpoint
CREATE INDEX `admin_identity_handoff_events_user_created_idx` ON `admin_identity_handoff_events` (`user_id`,`created_at`);--> statement-breakpoint
