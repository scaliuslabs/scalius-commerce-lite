...
DROP INDEX IF EXISTS `order_support_request_events_request_created_idx`;
--> statement-breakpoint
DROP INDEX IF EXISTS `order_support_request_events_order_created_idx`;
--> statement-breakpoint
DROP INDEX IF EXISTS `order_support_requests_active_key_unique`;
--> statement-breakpoint
DROP INDEX IF EXISTS `order_support_requests_order_created_idx`;
--> statement-breakpoint
DROP INDEX IF EXISTS `order_support_requests_customer_created_idx`;
--> statement-breakpoint
DROP INDEX IF EXISTS `order_support_requests_status_created_idx`;
--> statement-breakpoint
DROP INDEX IF EXISTS `order_support_requests_type_status_idx`;
--> statement-breakpoint
ALTER TABLE `order_support_requests` RENAME TO `order_support_requests_old`;
--> statement-breakpoint
ALTER TABLE `order_support_request_events` RENAME TO `order_support_request_events_old`;
--> statement-breakpoint
...
SELECT
	...
	`created_at`,
	`updated_at`
FROM `order_support_requests_old`;
--> statement-breakpoint
...
--> statement-breakpoint
INSERT INTO `order_support_request_events` (
	`id`,
	`request_id`,
	`order_id`,
	`customer_id`,
...
SELECT
	...
	`note`,
	`created_at`
FROM `order_support_request_events_old`;
--> statement-breakpoint
...
--> statement-breakpoint
DROP TABLE `order_support_request_events_old`;
--> statement-breakpoint
DROP TABLE `order_support_requests_old`;
--> statement-breakpoint
