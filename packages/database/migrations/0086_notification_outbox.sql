...
CREATE TABLE `notification_outbox` (
	...
	CONSTRAINT "notification_outbox_subject_shape" CHECK(("notification_outbox"."subject_type" <> 'order' OR "notification_outbox"."order_id" IS "notification_outbox"."subject_id") AND ("notification_outbox"."subject_type" <> 'conversation' OR "notification_outbox"."conversation_id" IS "notification_outbox"."subject_id")),
...
CREATE TABLE `notification_delivery_receipts` (
	...
	CONSTRAINT "notification_delivery_receipts_order_shape" CHECK("notification_delivery_receipts"."subject_type" <> 'order' OR "notification_delivery_receipts"."order_id" IS "notification_delivery_receipts"."subject_id")
);
--> statement-breakpoint
