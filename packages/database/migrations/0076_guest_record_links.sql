...
ALTER TABLE `customers` ADD `linked_account_id` text;
--> statement-breakpoint
CREATE INDEX `customers_linked_account_idx` ON `customers` (`linked_account_id`);
--> statement-breakpoint
ALTER TABLE `customer_history` ADD `order_id` text;
--> statement-breakpoint
ALTER TABLE `customer_history` ADD `related_customer_id` text;
--> statement-breakpoint
