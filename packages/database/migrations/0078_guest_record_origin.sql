...
ALTER TABLE `customers` ADD `origin` text DEFAULT 'order' NOT NULL;
...
--> statement-breakpoint
ALTER TABLE `customer_history` ADD `verified_contact` text;
--> statement-breakpoint
ALTER TABLE `customer_history` ADD `actor` text;
--> statement-breakpoint
ALTER TABLE `customer_history` ADD `actor_id` text;
--> statement-breakpoint
INSERT INTO `scalius_schema_migrations` (`version`, `name`, `source_sha256`) VALUES (78, '0078_guest_record_origin', '95b284f716293447b94c3474bf53e21d0262ed589ed91ed1087084bcbb7f1c2b');
