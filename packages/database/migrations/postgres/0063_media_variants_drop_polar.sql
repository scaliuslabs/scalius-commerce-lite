...
--> statement-breakpoint
ALTER TABLE "order_payments" DROP COLUMN IF EXISTS "polar_checkout_id";
--> statement-breakpoint
ALTER TABLE "media" ADD COLUMN "variant_width" integer;
--> statement-breakpoint
ALTER TABLE "media" ADD CONSTRAINT "media_variant_width_valid" CHECK("media"."variant_width" IS NULL OR ("media"."kind" = 'image' AND "media"."variant_width" BETWEEN 1 AND 2400));
--> statement-breakpoint
