...
ALTER TABLE `orders` ADD `order_number` integer;
...
--> statement-breakpoint
ALTER TABLE `cod_tracking` ADD `failure_note` text;
--> statement-breakpoint
ALTER TABLE `order_items` ADD `shipped_quantity` integer DEFAULT 0 NOT NULL;
--> statement-breakpoint
