// PostgreSQL sidecar parity for the Wave A migrations (0083-0086): an 0082
...
async function applySidecars(client: Client): Promise<void> {
  for (const name of WAVE_A_SIDECARS) {
...
describe.runIf(postgresUrl)("Wave A PostgreSQL sidecars", () => {
  it("upgrade an 0082 schema to exactly the fresh 0086 schema", async () => {
