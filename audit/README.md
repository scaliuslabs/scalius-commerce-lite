...
- `pnpm test` currently passes: 353 files and 2387 tests.
- `pnpm --filter @scalius/database check:migrations` passes: 78 SQL files, 78 journal entries, 32 snapshots, and 46 allowed manual snapshot gaps.
