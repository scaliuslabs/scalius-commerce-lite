...
- Latest full `pnpm deploy` passed after the `PERF-003` discount-edit lazy-loading slice and `CACHE-012` catalog-purge false-500 fix, redeploying API `f9597a03-f87b-4296-9966-cbfecb999c4c`, admin `0e960b5d-cde9-46a8-88ef-ba01fbd1211c`, and storefront `862559f7-d881-4b78-b8a4-6b8a3a68d624`. A follow-up admin-only deploy for the discount-date hydration fix deployed admin `80104b0b-2d5c-47a1-a14f-baca5a6fa7e4`.
