...
- `pnpm test` currently passes: 330 files and 2252 tests.
- `pnpm --filter @scalius/database check:migrations` passes: 77 SQL files, 77 journal entries, 32 snapshots, and 45 allowed manual snapshot gaps.
