...
! rg "api\\.queries" \
  ...
  apps/admin-v2/src/routes/admin/settings/delivery-providers.tsx \
  apps/admin-v2/src/routes/admin/settings/fraud-checker.tsx \
  apps/admin-v2/src/routes/admin/settings/hero-sliders.tsx \
