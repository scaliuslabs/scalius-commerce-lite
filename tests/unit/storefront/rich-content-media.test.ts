...
describe("rich content image optimization behavior", () => {
  ...
  it("optimizes inline background image URLs in rich HTML", () => {
    const html =
      '<section style="background-image:url(https://cloud.scalius.com/cms/hero.jpg)">Hero</section>';
  ...
  it("optimizes picture source srcset candidates while preserving descriptors", () => {
    const html = [
      "<picture>",
      '<source media="(min-width: 768px)" srcset="https://cloud.scalius.com/cms/hero-large.webp 1200w, https://cloud.scalius.com/cms/hero-large@2x.webp 2x">',
      '<img src="https://cloud.scalius.com/cms/hero.webp" alt="Hero">',
      "</picture>",
    ].join("");
    ...
    expect(optimized).not.toContain(
      'srcset="https://cloud.scalius.com/cms/',
    );
  });

  it("marks the first priority rich-content image as eager with larger candidates", () => {
    const html =
      '<section><img src="https://cloud.scalius.com/cms/hero.jpg" alt="Hero"><img src="https://cloud.scalius.com/cms/secondary.jpg" alt="Secondary"></section>';
  ...
  it("keeps rich content responsive image variants width-only", () => {
    const html =
      '<img src="https://cloud.scalius.com/cms/freeform-photo.jpg" alt="Freeform">';
  ...
  it("rebuilds rich content variants from stale pre-optimized image URLs", () => {
    const html =
      '<img src="https://cloud.scalius.com/cdn-cgi/image/onerror=redirect,width=400,height=400,quality=80,format=auto,fit=cover,sharpen=1/cms/freeform-photo.jpg" alt="Freeform">';
    ...
    expect(optimized).toContain("/cms/freeform-photo.jpg");
  });

  it("normalizes stale image loading attributes", () => {
    const html =
      '<img src="https://cloud.scalius.com/cms/hero.jpg" loading="lazy" fetchpriority="low" decoding="sync" alt="Hero">';
  ...
  it("optimizes rich-content CSS url() images without rewriting fonts", () => {
    const css = [
      ".hero { background-image: url('https://cloud.scalius.com/cms/bg.webp'); }",
  ...
  it("does not route SVG assets through Cloudflare image resizing", () => {
    const html = '<img src="https://cloud.scalius.com/cms/logo.svg" alt="Logo">';
    const css = ".logo { background-image: url('https://cloud.scalius.com/cms/logo.svg'); }";
