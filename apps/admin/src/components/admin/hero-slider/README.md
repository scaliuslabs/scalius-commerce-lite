...
| `helpers.ts` | Type definitions (`SliderImage`, `HeroSlider`, `MediaFile`) and `generateImageId()` utility |
...
- **Drag-and-drop**: Reorders images array, persists on drag end
...
- `@/hooks/useDebouncedCallback` -- debounce wrapper
