    ...
    },
    {
      ...
      steps: [
        ...
        },
        {
          ...
          input: {
            template: { body: { discovery: {}, expectedRevision: null } },
            dependencies: [{
              templatePointer: "/body/expectedRevision",
              source: { kind: "step", phaseId: "resolve", stepId: "seo", responsePointer: "/data/revision" },
            }],
            defaults: [],
          },
          policies: { ...createPolicies, revision: "required" },
        },
      ],
    },
    {
...
export const DAILY_OPERATING_SNAPSHOT_WORKFLOW: AgentWorkflowCard = {
          ...
          output: {
            selectors: [
              ...
              },
              {
                ...
                fields: [
                  { pointer: "/id", alias: "id" },
                  { pointer: "/kind", alias: "kind" },
                  { pointer: "/name", alias: "name" },
                  { pointer: "/fee", alias: "fee" },
                  { pointer: "/freeOver", alias: "freeOver" },
  ...
  verification: [
    ...
    },
    {
      ...
      surface: "dashboard",
      operationId: "dashboard.shipping_methods.list",
      responsePointers: ["/data/zones", "/data/everywhereElse"],
      proves: ["Saved zones and everywhere-else charges."],
