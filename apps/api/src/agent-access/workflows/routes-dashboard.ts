...
export const DASHBOARD_AGENT_WORKFLOW_ROUTES = [
  ...
  },
  {
    ...
    tags: ["discounts", "codes", "automatic", "activation"],
    operationIds: [
  ...
  },
  {
    ...
    tags: ["bangladesh", "bdt", "checkout", "delivery-zones"],
    operationIds: [
      "dashboard.settings.currency_get",
      "dashboard.payments.methods_get",
      "dashboard.shipping_methods.list",
  ...
  },
  {
    ...
    tags: ["shipping", "delivery", "zones", "checkout"],
    operationIds: [
      "dashboard.shipping_zones.create",
      "dashboard.shipping_methods.list",
      "storefront.shipping_methods.list",
  ...
  },
  {
    ...
    rules: [
      ...
      "Declared order events: order_created, order_confirmed, order_processing, order_shipped, order_ready_for_pickup, order_delivered, order_completed, order_cancelled, order_returned.",
      "Also declared: refund_processing, refund_failed, order_refunded, order_partially_refunded, payment_balance_paid, support_request_submitted, support_request_status_updated; conversation_reply, order_digital_delivered, gift_card_issued, gift_card_sent, review_request (email or SMS only).",
