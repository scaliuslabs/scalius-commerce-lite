...
export const DASHBOARD_AGENT_WORKFLOW_ROUTES = [
  ...
  },
  {
    ...
    rules: [
      ...
      "Also declared: refund_processing, refund_failed, order_refunded, order_partially_refunded, payment_balance_paid, support_request_submitted, support_request_status_updated; conversation_reply, order_digital_delivered, gift_card_issued, review_request (email or SMS only).",
