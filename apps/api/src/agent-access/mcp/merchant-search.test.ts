...
describe("merchant operation search", () => {
  it.each([
    ...
    ["dashboard.settings.business_get business settings", "change store settings"],
    ["dashboard.shipping_methods.list shipping methods", "change shipping settings"],
    ["dashboard.taxes.settings_get tax settings", "show tax configuration"],
    ["dashboard.settings.email_get email settings", "change email settings"],
    ["dashboard.settings_sms.get_sms SMS provider settings", "show SMS settings"],
    ["dashboard.settings.customer_auth_get customer authentication settings", "change login settings"],
    ["dashboard.seo.settings_get SEO settings", "show discovery configuration"],
    ["dashboard.theme.workspace_get storefront theme workspace", "change theme settings"],
    ...
    ["dashboard.orders.list fulfillment filters", "what needs fulfillment today"],
    ["dashboard.customers.list bounded customer summaries", "who are our top customers"],
    ["dashboard.orders.payment_recovery_list payment recovery", "are any payments failing"],
