...
> = {
  ...
  "DELETE /admin/agent-access/connections/revoked": reviewedExclusionMetadata(
...
const PLATFORM_SETTINGS_OPERATION_TUPLES: readonly DashboardOperationTuple[] = [
  ...
  ["dashboard.settings.platform_get", "read", false, "none", "none", "parallel"],
  ["dashboard.settings.platform_update", "write", false, "none", "none", "sequential"],
...
> = {
  ...
  "dashboard.settings.platform_get": { request: 16_384, response: 16_384 },
  "dashboard.settings.platform_update": { request: 16_384, response: 16_384 },
