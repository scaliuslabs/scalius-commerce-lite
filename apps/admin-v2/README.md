...
- **Rich Text**: Sanitized rich previews that lazy-split Tiptap out of route bundles, then mount the real editor immediately after field hydration or direct interaction (images, tables, YouTube, resizable images)
