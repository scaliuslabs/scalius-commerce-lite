...
export function AdminHeader({ user }: AdminHeaderProps) {
  ...
  return (
    <header className="h-14 border-b border-border px-3 sm:px-4 flex items-center justify-between sticky top-0 z-20 backdrop-blur-sm bg-background/95 transition-colors duration-200">
