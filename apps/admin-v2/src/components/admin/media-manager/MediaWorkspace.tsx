      ...
      <div className="flex min-h-0 flex-1 flex-col md:flex-row">
        ...
        <main className="flex min-h-0 min-w-0 flex-1 flex-col">
          ...
          <div className="min-h-0 flex-1">
            <MediaGallery files={mm.files} selectedFileIds={mm.selectedFileIds} selectionMode={mm.selectionMode} view={mm.view} isLoading={mm.isLoading} isLoadingMore={mm.isLoadingMore} hasMore={mm.hasMore} onFileSelect={mm.handleFileSelect} onFilePreview={(file, event) => { event.stopPropagation(); mm.setPreviewFile(file); mm.setShowPreview(true); }} onToggleSelection={mm.toggleSelection} onLifecycle={lifecycle} onLoadMore={mm.loadMore} />
          </div>
        </main>
      </div>
