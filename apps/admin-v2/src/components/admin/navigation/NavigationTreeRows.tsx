// src/components/admin/navigation/NavigationTreeRows.tsx
...
interface NavigationTreeRowProps extends Omit<NavigationTreeRowsProps, "navigation"> {
  item: NavigationItem;
  index: number;
  depth: number;
  canIndent: boolean;
...
export function NavigationTreeRows({
  navigation,
...
const NavigationTreeRow = memo(function NavigationTreeRow({
  item,
  index,
  depth,
  maxDepth = MAX_NAV_DEPTH,
        ...
        >
          <div className="flex items-center gap-0.5">
            ...
            <Button
              ...
              onClick={onReorderRequest}
              disabled={!canReorder}
              title="Reorder navigation items"
              aria-label="Reorder navigation items"
            >
