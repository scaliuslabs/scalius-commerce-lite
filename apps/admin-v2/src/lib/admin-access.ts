import {
  getDefaultAdminPage as getCoreDefaultAdminPage,
  getPagePermission as getCorePagePermission,
  hasPageAccess as hasCorePageAccess,
...
export function getAdminPagePermission(
  ...
  return getCorePagePermission(normalizeAdminPath(pathname));
}
...
function getDefaultAdminPage(
  ...
  return getCoreDefaultAdminPage(permissions, isSuperAdmin);
}
