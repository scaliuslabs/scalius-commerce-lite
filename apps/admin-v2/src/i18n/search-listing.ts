...
export const searchListingMessages = defineMessages({
  en: {
    ...
    empty_brand: "Add a title and description to see how this brand might appear in a search engine listing.",
  ...
  bn: {
    ...
    empty_brand: "সার্চ ইঞ্জিনে এই ব্র্যান্ড কেমন দেখাবে তা দেখতে একটি টাইটেল ও বর্ণনা দিন।",
