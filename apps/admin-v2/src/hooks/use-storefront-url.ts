...
import { getStorefrontUrl } from "~/lib/api.functions";
...
/**
 * Fetches the storefront URL via server function
 */
async function fetchStorefrontUrl(): Promise<string> {
  ...
  // Create new promise using server function
  globalPromise = getStorefrontUrl()
