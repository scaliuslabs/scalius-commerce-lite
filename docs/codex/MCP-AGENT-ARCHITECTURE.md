...
- Expose read/search tools first. Current verified tools cover products, categories, collections, CMS pages, orders, media listing, and inventory lookup; the remaining first-release read surfaces are dashboard summary and carefully redacted read-only settings.
