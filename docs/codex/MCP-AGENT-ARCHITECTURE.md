...
- Expose read/search tools first. Current verified tools cover products, categories, collections, CMS pages, orders, and media listing; the remaining first-release read surfaces are dashboard summary, inventory lookup, and carefully redacted read-only settings.
