...
- Expose read/search tools first. Current verified tools cover dashboard summary, redacted settings and analytics readiness, products, categories, collections, CMS pages, orders, media listing, and inventory lookup.
