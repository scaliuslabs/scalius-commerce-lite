...
| Account / users | [`../COMMERCE-SETTINGS-BENCHMARK.md`](../COMMERCE-SETTINGS-BENCHMARK.md) | Profile/security/team sections are URL-owned, personal sessions are bounded and revocable, suspension preserves identity while atomically revoking sessions, and durable invitation expiry/delivery/accept/revoke authority is live; security-event history and bulk operations remain |
